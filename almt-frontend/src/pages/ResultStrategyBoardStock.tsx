...
const ResultStrategyBoardStockPage = () => (
  <ResultViewLayout
    endpoint="/result-view/strategy-board-stock"
    title="策略看板（存量）"
    description="账户册树形 + M0~M24 共 25 期，所有期均为当前存量数据。"
    fixedColumns={fixedColumns}
    mGroups={mGroups}
  />
)

export default ResultStrategyBoardStockPage